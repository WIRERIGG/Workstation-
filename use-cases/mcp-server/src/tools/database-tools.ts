...
const ExecuteDatabaseSchema = z.object({
  sql: z.string().min(1, "SQL statement cannot be empty"),
});
...
export function registerDatabaseTools(server: McpServer, env: any, props: Props) {
